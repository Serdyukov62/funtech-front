    ...
    <section className="eventPage-main-container">
      <div className="eventPage-event">
        ...
        <p className="text">
          ...
          столкнётся отрасль технологических сервисов для больших компаний
          в ближайшем будущем. Это несколько продуктивных часов для обмена
          опытом и нетворка. Мероприятие будет интересно и безусловно полезно
          всем специалистам направления HR Tech. Это первая встреча в череде
          регулярных событий. На ней мы рассмотрим опыт сразу нескольких крупных
          компаний в области HR Tech — коллеги представят доклады о создании
          и совершенствовании экосистем внутренних сервисов и применении
